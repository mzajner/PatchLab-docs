...
paths, unreleased assets, and licensed audio before attaching logs or projects.

The project is provided without a guaranteed response time. A supported host, format,
or platform is only one marked as verified in the published support matrix for a named
release artifact.
